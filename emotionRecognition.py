...
emotions = {
    0: {"emotion": "Angry", "color": (193, 69, 42), "emoji": "emojis/angry.png"},
    1: {"emotion": "Disgust", "color": (164, 175, 49), "emoji": "emojis/disgust.png"},
    2: {"emotion": "Fear", "color": (40, 52, 155), "emoji": "emojis/fear.png"},
    3: {"emotion": "Happy", "color": (23, 164, 28), "emoji": "emojis/happy.png"},
    4: {"emotion": "Sad", "color": (164, 93, 23), "emoji": "emojis/sad.png"},
    5: {"emotion": "Surprise", "color": (218, 229, 97), "emoji": "emojis/surprise.png"},
    6: {"emotion": "Neutral", "color": (108, 72, 200), "emoji": "emojis/neutral.png"}
}
...
def overlay_image(background, overlay, x, y, overlay_size):
    ...
    for i in range(h):
        for j in range(w):
            if overlay[i, j][3] != 0:  # Check for transparency
...
while True:
    ...
    for rect in rects:
        ...
        if emotion_probability > 0.36:
            ...
            frame = overlay_image(frame, emoji, x + w + 10, y, (50, 50))
